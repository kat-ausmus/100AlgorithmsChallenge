...
For upSpeed = 100, downSpeed = 10 and desiredHeight = 910, the output should be growingPlant(
...
The number of days that it will take for the plant to reach/pass desiredHeight (including the last
day in the total count).
